...
model_dir = 'mse'
directory = f"/glade/derecho/scratch/tsatoperry/GAD/models/{model_dir}/singular_values"
...
plt.tight_layout()
plt.savefig(f"sv_trend_{model_dir}1.png", dpi=150)
print(f"sv_trend_{model_dir}.png")
